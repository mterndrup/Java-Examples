...
public class SOAPClientSAAJ {
    ...
    /**
     * Starting point for the SAAJ - SOAP Client Testing (Created Jan 31, 2015
	 * Information gathered from this Stackoverflow question: 
    ...
    public static void main(String args[]) {
        try {
            ...
            String url = "http://example.com/request.asmx";
    ...
    private static SOAPMessage createSOAPRequest() throws Exception {
        ...
        soapBodyElem1.addTextNode("example@gmail.com");
